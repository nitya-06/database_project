...
$conn = mysqli_connect('localhost', 'root', 'Ashutosh@2003', 'db_project');
  ...
  <tr>
        ...
        <th scope="col"> Area Of Working</th>
        <th scope="col"> Location</th>
        <th scope="col"> Working Tenure</th>
        <th scope="col"> CTC</th>
  ...
  <tbody>
        <?php
            $sql = "SELECT * FROM Alumni natural join Alumni_marks order by RollNo";
            ...
            foreach($result as $row1){
                ...
                <tr style="font-size:smaller">
                    ...
                    <td> <?=$row1['degree']?></td>
                    <td> <?=$row1['branch']?></td>
                    <td> <?=$row1['batch_year']?></td>
                    <td> <?=$row1['area_of_working']?></td>
                    <td> <?=$row1['Location']?></td>
                    <td> <?=$row1['working_tenure']?></td>
                    <td> <?=$row1['Ctc']?></td>
