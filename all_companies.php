...
<?php
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarRightAlignExample">
                ...
                <ul class="navbar-nav ms-auto me-5 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="all_companies.php">Companies</a>
                    </li>
    ...
    <div class="container1">
        ...
        <div class="year-selector">
            <?php echo('<button class="year-btn" onclick=location.href=`year.php?year=2022` data-year="2022">2022-2023</button>')?>
            <?php echo('<button class="year-btn" onclick=location.href=`year.php?year=2021` data-year="2021">2021-2022</button>')?>
            <?php echo('<button class="year-btn" onclick=location.href=`year.php?year=2020` data-year="2020">2020-2021</button>')?>
            <?php echo('<button class="year-btn" onclick=location.href=`year.php?year=2019` data-year="2019">2019-2020</button>')?>
            <?php echo('<button class="year-btn" onclick=location.href=`year.php?year=2018` data-year="2018">2018-2019</button>')?>
            <?php echo('<button class="year-btn" onclick=location.href=`year.php?year=2017` data-year="2017">2017-2018</button>')?>
