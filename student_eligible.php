...
<head>
    ...
    <title>Eligible Companies | Job Junction</title>
...
<?php
    ...
    if(($_SESSION['eligible']==0)){
        $_SESSION['error1'] = "Please update details to check eligibility";
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarRightAlignExample">
                ...
                <ul class="navbar-nav ms-auto me-5 mb-lg-0">
                    ...
                    <li class="nav-item" style="color: aqua;">
                        <a class="nav-link active" href="student_eligible.php">Check Eligibility </a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <?php
            ...
            $conn = mysqli_connect('localhost', 'root', 'Ashutosh@2003', 'db_project');
            $rollno = $_SESSION['rollno'];
            $sql1 = "Select * from Student_marks natural join Student where RollNo = '$rollno'";
            ...
            $sql = "SELECT * FROM Company natural join Company_marks where Company_marks.10th_marks<=$marks_10 and Company_marks.12th_marks<=$marks_12 and Company_marks.cpi<=$cpi and Company.Interest='$inter' ";
            $result = mysqli_query($conn, $sql);
            $num = mysqli_num_rows($result);
            if($num==0){
                echo("<h1>No companies found</h1>");
            }
            else{
        ...
        <div class="card">
            ...
            <div class="card-info">
                ...
                <div class="card-field">Ctc: <?=$row['ctc']?> Lpa</div>
                <div class="card-email">E-mail <?=$row['Email']?></div>
                <div class="card-email">Company Field <?=$row['c_field']?></div>
            </div>
        </div>
        <?php
                }
        ...
        <!-- <div class="card">
            ...
            <div class="card-info">
                ...
                <div class="card-field">roll name</div>
                <div class="card-email">web mail</div>
            </div>
        </div> -->
    </div>
