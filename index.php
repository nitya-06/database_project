...
<link href="https://fonts.googleapis.com/css2?family=Changa:wght@200&family=M+PLUS+1+Code:wght@300&family=Mukta:wght@300;400&family=Preahvihear&family=Zilla+Slab:wght@300&display=swap" rel="stylesheet">
  <!-- Font Awesome -->
...
<body>
  ...
  <div class="main_container">
    <div class="text_home">
      ...
      <p >IIT Patna</p>
    <p>Job Junction</p>
    <button style="font-size:24px; border-radius: 10px;"> <a href="mailto:iitp_job@iitp.ac.in">iitp_job@iitp.ac.in </a><i class="fa fa-envelope"></i></button>
  
  </div>
    
      <!-- <img src="iitp_home.jpg" class="img-fluid home_img" alt="Responsive image" /> -->
    <!-- </div> -->
    <!-- <div> -->
