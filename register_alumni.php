    ...
    <div class="container registration-container">
        ...
        <form action="reg_alumni.php" method="post">
            <div class="form-group">
                ...
                <input type="text" id="username" name="Name" class="form-control" placeholder="Name" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="RollNo" name="RollNo" class="form-control" placeholder="RollNo" required>
            </div>
            <div class="form-group">
